...
## Environments
- Preview: https://main--sdmcraft-ecat-eval--aemysites.aem.page/
- Live: https://main--sdmcraft-ecat-eval--aemysites.aem.live/
- Block Library: https://main--sdmcraft-ecat-eval--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sdmcraft-ecat-eval` directory in your favorite IDE and start coding :)
